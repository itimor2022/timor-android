...
public class WKLoginActivity extends WKBaseActivity<ActLoginLayoutBinding> implements LoginContract.LoginView {
    ...
    protected void initView() {
        ...
        wkVBinding.baseUrlTv.setTextColor(Theme.colorAccount);
        wkVBinding.versionTv.setTextColor(Theme.colorAccount);
        ...
        wkVBinding.versionTv.setText(String.format("v%s", v));
